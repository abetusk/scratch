...
// y i srelative luminance (mostly)?
...
if (module && (module.exports)) {
  module.exports.rgb2xyz = rgb2xyz;
  module.exports.xyz2rgb = xyz2rgb;

  module.exports.cat022xyz = cat022xyz;
  module.exports.xyz2cat02 = xyz2cat02;

  //export { rgb2xyz, xyz2rgb };
  /*
function rgb2xyz(r, g, b) {
function xyz2rgb(x, y, z) {
  function toRGB(c) {
